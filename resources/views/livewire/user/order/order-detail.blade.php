        ...
        <div class="gap-8 p-8">
            ...
            <div>
                ...
                <div class="space-y-3 mt-6">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-black text-md font-medium">Cepat (1-2 Hari)</span>
                        </div>
                        <span class="text-md text-gray-700 shrink-0 ml-4">Rp 30.000</span>
                    </div>
                </div>
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-2xl text-[#2E7D32] shrink-0 ml-4 font-semibold">Rp {{ number_format($order->total_product, 0, ',', '.') }}</span>
                </div>

                ...
                <div class="space-y-3 mt-6">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="flex items-center gap-2">
                            ...
                            <span class="text-black text-md font-medium">{{ $order->shipping->courier }} | {{ $order->shipping->service }}</span>
                        </div>
                        <span class="text-md text-gray-700 shrink-0 ml-4">Rp {{ number_format($order->shipping->cost, 0, ',', '.') }}</span>
                    </div>
                </div>

<div>
    ...
    <div class="flex flex-wrap gap-4 items-center">
        ...
        <div class="relative flex item-center gap-2 flex-1 border-3 rounded-lg px-4 py-2 w-full focus-within:ring-0 focus-within:ring-[#2E7D32] focus-within:border-[#2E7D32] transition">

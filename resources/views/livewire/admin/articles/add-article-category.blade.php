            ...
            <div class="relative z-10 w-full max-w-md rounded-2xl p-6 bg-white dark:bg-neutral-800 shadow-xl">
                ...
                <div class="mb-5">
                    ...
                    <div class="max-h-48 overflow-y-auto space-y-2">
                        ...
                        @forelse ($categories as $item)
                            ...
                            <div
                                wire:key="category-{{ $item->id }}"
                                class="flex items-center justify-between gap-3 px-3 py-2.5 rounded-lg bg-gray-50 dark:bg-neutral-700 border border-gray-200 dark:border-neutral-600">

                                @if ($categoryToDelete === $item->id)

                                    <div class="flex items-center gap-2 min-w-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-4 h-4 text-red-500 shrink-0">
                                        ...
                                        <span class="flex-1 min-w-0 text-sm text-gray-700 dark:text-gray-200 leading-relaxed">
                                            Hapus "{{ $item->category }}"? Menghapus kategori akan menghapus semua artikel yang terkait.
                                        </span>
                                    </div>
                ...
                <div class="flex justify-end gap-3 mt-6">
                    ...
                    <button
                        ...
                        wire:loading.attr="disabled"
                        wire:target="save"
                        class="px-4 py-2 rounded-lg bg-green-600 hover:bg-green-700 text-white font-medium disabled:opacity-50">
